...
**Regras (v7.0 — Operationalization):**
...
- Tags DEVEM seguir taxonomia controlada em `docs/qa/rca-knowledge/tag-taxonomy.yaml` — tags invalidas DEVEM ser corrigidas ou usar prefixo `custom:`
- Anti-patterns DEVEM incluir todos os campos obrigatorios do schema v6.0
- Schema validation checklist (Fase 8 secao 17) eh OBRIGATORIA antes de registrar investigacao
...
- Evidence Summary DEVE ter pelo menos 1 achado E1_confirmed para prosseguir para Fase 7
