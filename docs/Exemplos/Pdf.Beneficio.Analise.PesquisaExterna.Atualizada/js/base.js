...
function inicializarCamposParaBindings() {
    const carta = data.BeneficioAnalisePesquisaExterna = data.BeneficioAnalisePesquisaExterna || {};
    ...
    carta.ResponsaveisFornecedor = carta.ResponsaveisFornecedor || {};
    carta.ResponsaveisFornecedor.ResponsavelFornecedor = garantirArray(carta.ResponsaveisFornecedor.ResponsavelFornecedor);
    carta.ResponsaveisFornecedor.ResponsavelFornecedor.forEach(doc => {
        doc.Nome ??= '';
        doc.Documento ??= '';
    });

    carta.DataPesquisaExterna ??= '';
    carta.Local ??= '';
}

function gerarDataFormatada(dataString = data.BeneficioAnalisePesquisaExterna?.Data) {
...
function iniciarRenderizacaoSequencialSincrono() {
    ...
    const carta = data?.BeneficioAnalisePesquisaExterna
