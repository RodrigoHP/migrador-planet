...
function inicializarCamposParaBindings() {
    const carta = data.AnaliseBeneficio = data.AnaliseBeneficio || {};
...
function gerarDataFormatada(dataString = data.AnaliseBeneficio?.Data) {
...
function iniciarRenderizacaoSequencialSincrono() {
    ...
    data.AnaliseBeneficio.DataFormatada = gerarDataFormatada();
