...
function montarTextosCarencia() {
    ...
    // Suicídio
    if (franquia?.CARENCIA_SUICIDIO?.TEXTO_CARENCIA_SUICIDIO) {
        textos.push(franquia.CARENCIA_SUICIDIO.TEXTO_CARENCIA_SUICIDIO.trim());
    }
...
function formatarCPF() {
    cpf = data.KIT_BOAS_VINDAS.DADOS_SEGURADO.CPF.toString().padEnd(11, '0')
    data.KIT_BOAS_VINDAS.DADOS_SEGURADO.CPF = cpf.replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, '$1.$2.$3-$4')
}
