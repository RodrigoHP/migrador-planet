...
function inicializarCamposParaBindings() {
    const carta = data.PagamentoBeneficioAvisoBeneficiario = data.PagamentoBeneficioAvisoBeneficiario || {};
...
function gerarDataFormatada(dataString = data.PagamentoBeneficioAvisoBeneficiario?.Data) {
...
function iniciarRenderizacaoSequencialSincrono() {
    ...
    const carta = data?.PagamentoBeneficioAvisoBeneficiario
