...
function inicializarCamposParaBindings() {
  const carta = data.BeneficioAvisoClienteBeneficioSolicitado = data.BeneficioAvisoClienteBeneficioSolicitado || {};

  carta.NumeroProtocolo ??= '';
  carta.NomeCliente ??= '';
  ...
  carta.GrauParentesco ??= '';

  carta.DocumentosEntreguesCliente = carta.DocumentosEntreguesCliente || {};
  carta.DocumentosEntreguesCliente.DocumentoEntregue = Array.isArray(carta.DocumentosEntreguesCliente.DocumentoEntregue)
    ? carta.DocumentosEntreguesCliente.DocumentoEntregue
    : [];

  carta.DocumentosEntreguesSolicitante = carta.DocumentosEntreguesSolicitante || {};
  carta.DocumentosEntreguesSolicitante.DocumentoEntregue = Array.isArray(carta.DocumentosEntreguesSolicitante.DocumentoEntregue)
    ? carta.DocumentosEntreguesSolicitante.DocumentoEntregue
    : [];
}
