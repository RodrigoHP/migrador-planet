...
function gerarDataFormatada(dataString = data.BeneficioAvisoClienteBeneficioSolicitado?.DataStatus) {
...
function iniciarRenderizacaoSequencialSincrono() {
    ...
    const carta = data?.BeneficioAvisoClienteBeneficioSolicitado
