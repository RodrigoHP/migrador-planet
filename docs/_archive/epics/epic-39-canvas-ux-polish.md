...
| 39.3 | Column snap (backend data) | 3 | Ready for Review | I11 |
...
- **Wave 3** (complexa): 39.5, 39.8, 39.3

## Decisoes

- Story 39.3 implementada: wiring frontend via extractGridInfoFromTree() extrai column_positions da documentTree
