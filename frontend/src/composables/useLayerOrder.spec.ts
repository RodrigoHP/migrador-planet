...
function makeTree(): DocumentTree {
  return {
    root: {
      ...
      name: 'Root',
      children: [
        { id: 'a', type: 'field', name: 'A', children: [], properties: { zIndex: 10 }, visibility: true },
        { id: 'b', type: 'field', name: 'B', children: [], properties: { zIndex: 30 }, visibility: true },
        { id: 'c', type: 'field', name: 'C', children: [], properties: { zIndex: 20 }, visibility: true },
      ],
      properties: {},
      visibility: true,
    },
