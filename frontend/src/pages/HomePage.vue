  ...
  <FullWidthLayout :show-bibliotecas="true" @open-bibliotecas="isBibliotecasOpen = true">
    <div class="flex items-center justify-center min-h-[calc(100vh-56px)]">
      <div class="w-full max-w-2xl px-4">
        <h1 class="text-2xl font-bold text-center text-neutral-800 mb-8">Migrador Planetexpress</h1>

        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <!-- Card Novo Template -->
          <div
            class="border border-neutral-200 rounded-lg p-6 bg-white flex flex-col gap-4 text-center"
          >
          ...
          >
            ...
            <p class="text-sm text-neutral-600 flex-1 m-0">Retomar projeto salvo (.json)</p>
            <Button
              variant="secondary"
              class="w-full"
              :loading="isOpening"
