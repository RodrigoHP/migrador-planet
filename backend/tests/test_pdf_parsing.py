...
def test_parsed_document_serialisation():
    ...
    from models.parsed_document import CSSFont, GridInfo, ParsedDocument, ParsedImage, ParsedPage, TextBlock

    block = TextBlock(text="Hello", bbox=(0, 0, 100, 12), font_name="Arial", font_size=12.0, page_number=0, pdf_index=0)
